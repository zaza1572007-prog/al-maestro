    ...
    try {
      ...
      socketInstance.ev.on('connection.update', async (update: Partial<ConnectionState>) => {
        ...
        if (connection === 'close') {
          ...
          console.log(`🚀 Gateway ready and listening for incoming messages!`);
          console.log('======================================================');
        }
      });
...
// Start Server and WhatsApp & Tunnel
server.listen(PORT, '0.0.0.0', async () => {
  console.log(`\n======================================================`);
  console.log(`🌟 Al Maestro WhatsApp Service & Gateway`);
  ...
  try {
    console.log('🌐 Opening secure HTTPS tunnel for Vercel...');
    const tunnel = await localtunnel({ port: PORT });

    console.log('\n=================================================================');
    console.log('🎉 [Al Maestro WhatsApp Service is LIVE]');
    console.log('=================================================================');
    console.log(`🔗 Public Gateway URL:  ${tunnel.url}/send`);
    console.log(`🔑 API Token:            ${API_TOKEN}`);
    ...
    console.error('Tunnel notice:', err.message);
  }
});
