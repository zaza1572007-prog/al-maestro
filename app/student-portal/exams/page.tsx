...
export default function StudentExamsPage() {
  ...
  if (loading) {
    return <div className="text-center py-20 text-white animate-pulse">جارٍ تحميل الامتحانات...</div>;
  }

  return (
    <div className="space-y-8">
      <HeroHeader
        title="امتحاناتي ونتائجي 📝"
        badge="بوابة الطالب"
        subtitle="تفاصيل درجات الامتحانات وتقييم الأداء والمنافسة مع الزملاء"
        stats={[
          { label: "المتوسط", value: average, color: "text-purple-400" },
        ]}
      />
